...
this.elements.length-1;0<=c;c--)this.elements[c].$element.data("parallaxify-elementisactive",d);this.elements=[];this.options.parallaxelements&&this.$element.find("[data-parallaxify-range],[data-parallaxify-range-x],[data-parallaxify-range-y]").each(function(){var b="f(this);if(b.data("parallaxify-ElementIsActive")){if(b.data("parallaxify-ElementIsActive")!==this)return}else" b.data("parallaxify-elementisactive",this);b.data("parralaxify-originalleft")?(b.css("left",b.data("parallaxify-originalleft")),="" b.css("top",b.data("parallaxify-originaltop"))):(b.data("parallaxify-originalleft",b.css("left")),b.data("parallaxify-originaltop",b.css("top")));a.elements.push({$element:b,originalpositionleft:b.position().left,originalpositiontop:b.position().top,parallaxdistancex:b.data("parallaxify-range-x")!="=d?b.data("parallaxify-range-x"):b.data("parallaxify-range")!==d?b.data("parallaxify-range"):0,parallaxDistanceY:b.data("parallaxify-range-y")!==d?b.data("parallaxify-range-y"):b.data("parallaxify-range")!==" d?b.data("parallaxify-range"):0,width:b.outerwidth(!0),height:b.outerheight(!0)})})},_findbackgrounds:function(){var="" a="this,c;this.backgrounds=[];if(this.options.parallaxBackgrounds){c=this.$element.find("[data-parallaxify-background-range],[data-parallaxify-background-range-x],[data-parallaxify-background-range-y]");if(this.$element.data("parallaxify-background-range")||this.$element.data("parallaxify-background-range-x")||this.$element.data("parallaxify-background-range-y"))c=c.add(this.$element);" c.each(function(){var="" b.data("parallaxify-backgroundisactive",this);b.data("parralaxify-backgroundoriginalleft")?s(b,b.data("parallaxify-backgroundoriginalleft"),b.data("parallaxify-backgroundoriginaltop")):(b.data("parallaxify-backgroundoriginalleft",c[0]),b.data("parallaxify-backgroundoriginaltop",c[1]));a.backgrounds.push({$element:b,originalvalueleft:c[0],originalvaluetop:c[1],="" originalbackgroundpositionleft:isnan(parseint(c[0],10))?0:parseint(c[0],10),originalbackgroundpositiontop:isnan(parseint(c[1],10))?0:parseint(c[1],10),originalpositionleft:b.position().left,originalpositiontop:b.position().top,parallaxdistancex:b.data("parallaxify-background-range-x")!="=d?b.data("parallaxify-background-range-x"):b.data("parallaxify-background-range")!==d?b.data("parallaxify-background-range"):0,parallaxDistanceY:b.data("parallaxify-background-range-y")!==d?b.data("parallaxify-background-range-y"):" b.data("parallaxify-background-range")!="=d?b.data("parallaxify-background-range"):0})})}},_reset:function(){var" a,c,b,e;for(e="this.elements.length-1;0<=e;e--)a=this.elements[e],c=a.$element.data("parallaxify-originalLeft"),b=a.$element.data("parallaxify-originalTop"),this._setPosition(a.$element,c,c,b,b),a.$element.data("parallaxify-originalLeft",null).data("parallaxify-originalLeft",null).data("parallaxify-elementIsActive",null).data("parallaxify-backgroundIsActive",null);for(e=this.backgrounds.length-" 1;0<="e;e--)a=this.backgrounds[e],a.$element.data("parallaxify-backgroundOriginalLeft",null).data("parallaxify-backgroundOriginalTop",null).data("parallaxify-backgroundIsActive",null),s(a.$element,a.originalValueLeft,a.originalValueTop)},destroy:function(){this._reset();this.useMouseMove&&this.$viewportElement.unbind("mousemove."+this.name);this.useSensorWebkit&&g.removeEventListener("deviceorientation",this._handleSensorWebkit,!1);this.useSensorMoz&&g.removeEventListener("MozOrientation",this._handleSensorMoz," !1);f(g).unbind("load."+this.name).unbind("resize."+this.name).unbind("orientationchange."+this.name)},_processsensordata:function(){if(this.usesensor){var="" (this.initialgamma!="=d&&this.initialBeta!==d)&&(this.initialGamma=-180">c-this.initialGamma?j(c+360,this.initialGamma,this.options.alphaPosition):180<c-this.initialgamma?j(c-360,this.initialgamma,this.options.alphaposition):j(c,this.initialgamma,this.options.alphaposition),this.initialbeta=-90>a-this.initialBeta?j(a+180,this.initialBeta,this.options.alphaPosition):90<a-this.initialbeta?j(a-180,this.initialbeta,this.options.alphaposition):j(a,this.initialbeta,this.options.alphaposition));b=this.initialbeta!== d?a-this.initialbeta:a;e="this.initialGamma!==d?c-this.initialGamma:c;100<b?b-=180:-100">b&&(b+=180);200<e?e-=360:-200>e&&(e+=360);b=j(b,this.tilt.beta,this.options.alphaFilter);e=j(e,this.tilt.gamma,this.options.alphaFilter);this.tilt.beta=b;this.tilt.gamma=e}},_repositionElements:function(){var a=this._getMoveHorizontal(),c=this._getMoveVertical(),b,e,d,f;if(!(this.currentMoveHorizontal===a&&this.currentMoveVertical===c&&this.currentWidth===this.viewportWidth&&this.currentHeight===this.viewportHeight)){this.currentMoveHorizontal=
a;this.currentMoveVertical=c;this.currentWidth=this.viewportWidth;this.currentHeight=this.viewportHeight;for(f=this.elements.length-1;0</e?e-=360:-200></a-this.initialbeta?j(a-180,this.initialbeta,this.options.alphaposition):j(a,this.initialbeta,this.options.alphaposition));b=this.initialbeta!==></c-this.initialgamma?j(c-360,this.initialgamma,this.options.alphaposition):j(c,this.initialgamma,this.options.alphaposition),this.initialbeta=-90></=c;c--)this.elements[c].$element.data("parallaxify-elementisactive",d);this.elements=[];this.options.parallaxelements&&this.$element.find("[data-parallaxify-range],[data-parallaxify-range-x],[data-parallaxify-range-y]").each(function(){var></l.length?"t"+"transform".slice(1):"transform"),s=(n=f("<div></=-c)return></=-c)return></=-c?1:a>